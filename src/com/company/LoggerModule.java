    ...
    public void writelog(int function, int peerConnected, int peerHost, int pieceindex, int numpieces)
    {
        switch(function){
            ...
            case 5:     //receiving ‘have’ message
                ...
                //logger.info("Peer [" + peerConnected + "] received the ‘have’ message from [" + peer2 +"] for the piece [" + pieceindex + "].");
                break;
            case 6:     //receiving ‘interested’ message
                ...
                //logger.info("Peer [" + peerConnected + "] received the ‘interested’ message from [" + peer2 +"].");
                break;
            case 7:     //receiving ‘not interested’ message
                ...
                //logger.info("Peer [" + peerConnected + "] received the ‘not interested’ message from [" + peer2 +"].");
                break;
            case 8:     //downloading a piece
                ...
                //logger.info("Peer [" + peerConnected + "] has downloaded the piece [" + pieceindex + " from [" + peer2 +"]. Now the number of pieces it has is [" + numpieces + "].");
                break;
            case 9:     //completion of download
                System.out.println("[" + getcurrtime() + "]: Peer [" + peerHost + "] has downloaded the complete file.");
                //logger.info("Peer [" + peerConnected + "] has downloaded the complete file.");
                break;
            default:
        }
